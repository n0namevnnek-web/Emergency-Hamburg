...
local Config = {
    ...
    -- [6] GUI Management
    OldGuiName      = "NNVN Hub", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "NNVN Hub", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "NNVN Hub", -- The main title shown at the top of the GUI
    HubDescription  = "Emergency Hamburg" -- The text shown below the title
}
...
local function cacheLink()
    if cachedTime + (10*60) < fOsTime() then
        ...
        return false, err or "Please use a better executor"
    end
    return true, cachedLink
end
